...
aon: "https://2e.aonprd.com/Spells.aspx?ID=1231"
---

[[Spells Index]]

Source: [Transcribe Conflict on AoN](https://2e.aonprd.com/Spells.aspx?ID=1231)

**3rd** | Rare | Traits: Divination, Rare
**Range** touch

[[Rank 3rd]] [[Arcane]] [[Occult]]

You cause a sheet of paper to appear in your hand, and a moment later a detailed description of a combat you experienced within the last hour is recorded on that sheet of paper in a language that you know of your choice. The description is detailed enough that anyone who spends 1 minute reading the page can attempt to [Recall Knowledge](https://2e.aonprd.com/Actions.aspx?ID=26) about the event as if they had been there, but the primary purpose of the transcribed conflict is to give you additional insight into the fight by allowing you to study the conflict and learn from errors or tactical blunders participants in the battle may have committed.

 When you cast this spell, choose a type of foe in the fight you transcribed and attempt to Recall Knowledge about that foe using your spell DC–10 instead of your skill modifier in an appropriate skill to do so. For this action, you can't use any special abilities, reactions, or free actions that trigger when you Recall Knowledge. If you are successful, you not only learn information about that foe as determined by the GM, but for the remainder of _transcribe conflict's_ duration, you gain a +1 status bonus to Initiative checks in combats where you face that exact kind of foe. For example, if you made the check against a [wrath demon](https://2e.aonprd.com/Monsters.aspx?ID=100), the bonus would apply only to wrath demons, not to other [demons](https://2e.aonprd.com/MonsterFamilies.aspx?ID=28). The GM decides if a foe who is disguised grants you this bonus.
