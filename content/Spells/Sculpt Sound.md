...
aon: "https://2e.aonprd.com/Spells.aspx?ID=714"
---

[[Spells Index]]

Source: [Sculpt Sound on AoN](https://2e.aonprd.com/Spells.aspx?ID=714)

**3rd** | Common | Traits: Illusion
**Range** touch | **Target** 1 creature or object
...
**Critical Failure** The affected sound from the creature is altered and the target becomes [stupefied 2](https://2e.aonprd.com/Conditions.aspx?ID=37) for 1 minute as it struggles with the disorienting effects of its altered sound.
