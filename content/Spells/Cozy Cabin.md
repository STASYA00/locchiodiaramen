...
aon: "https://2e.aonprd.com/Spells.aspx?ID=1474"
---

[[Spells Index]]

Source: [Cozy Cabin on AoN](https://2e.aonprd.com/Spells.aspx?ID=1474)

**3rd** | Common | Traits: Concentrate, Manipulate, Wood
**Range** 30 feet

[[Rank 3rd]] [[Arcane]] [[Occult]]

You shape a cabin 20 feet on each side and 10 feet high. This cabin has the [structure](https://2e.aonprd.com/Traits.aspx?ID=153) trait and the same restrictions as magic items that create structures. The walls of the hut are simple and wooden, with small, square glass windows, and it has one wooden door. It doesn't include its own lock, but it has a fastener to which a lock can be applied.
