...
level: 3
rarity: Common
source: "Impossible Magic pg. 126"
aon: "https://2e.aonprd.com/Spells.aspx?ID=2648"
---

[[Spells Index]]

Source: [Bottomless Stomach on AoN](https://2e.aonprd.com/Spells.aspx?ID=2648)

**3rd** | Common | Traits: Concentrate, Extradimensional, Manipulate
**Range** touch | **Target** 1 willing creature

[[Rank 3rd]] [[Arcane]] [[Occult]] [[Primal]]
...
You create a shimmering extradimensional space accessible from the target's mouth. The space can hold objects and equipment, up to a total of 10 Bulk. This extradimensional storage doesn't hamper the target's ability to eat, drink, speak (if applicable), or otherwise act, as it only opens and closes when the target chooses.
 ...
 When the spell ends or the target falls [unconscious](https://2e.aonprd.com/Conditions.aspx?ID=95), the contents of the extradimensional storage are disgorged in a riotous spew, landing in the nearest unoccupied space, a bit wet but otherwise unharmed.
