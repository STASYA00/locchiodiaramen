...
aon: "https://2e.aonprd.com/Spells.aspx?ID=667"
---

[[Spells Index]]

Source: [Animate Rope on AoN](https://2e.aonprd.com/Spells.aspx?ID=667)

**1st** | Common | Traits: Transmutation
**Range** 100 feet | **Target** up to 50 feet of rope or a nonliving rope-like object
...
- **Bind** ([attack](https://2e.aonprd.com/Traits.aspx?ID=15)) The rope attempts to partially bind a creature. Attempt a spell attack roll against the target's Reflex DC. If you succeed, the target takes a –10-foot circumstance penalty to its Speed (–20-foot on a critical success). This ends if the target [Escapes](https://2e.aonprd.com/Actions.aspx?ID=79) against your spell DC or breaks the rope. (A standard adventuring rope has Hardness 2, HP 8, and a Broken Threshold of 4.)
